        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EmployeeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ReviewPeriod = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Status = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentPlanId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceLogs_TenantId_EmployeeId_CheckIn",
                table: "AttendanceLogs",
                columns: new[] { "TenantId", "EmployeeId", "CheckIn" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobApplications_TenantId_JobId_Status",
                table: "JobApplications",
                columns: new[] { "TenantId", "JobId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Jobs_TenantId_IsActive_PostedAt",
                table: "Jobs",
                columns: new[] { "TenantId", "IsActive", "PostedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Payrolls_TenantId_EmployeeId_Year_Month",
                table: "Payrolls",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PerformanceReviews_TenantId_EmployeeId_ReviewPeriod",
                table: "PerformanceReviews",
                columns: new[] { "TenantId", "EmployeeId", "ReviewPeriod" });

            migrationBuilder.CreateIndex(
                name: "IX_Requests_TenantId_EmployeeId_Status_RequestedAt",
                table: "Requests",
                columns: new[] { "TenantId", "EmployeeId", "Status", "RequestedAt" });
